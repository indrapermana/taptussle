            ...
            child: ListView(
              ...
              children: [
                const ArcadePanel(
                  ...
                  child: Text(
                    'Compare the same deterministic Paddle Duel rally with your saved and candidate graphics profiles.',
                    style: TextStyle(
                ...
                SegmentedButton<ResolutionPreset>(
                  ...
                  onSelectionChanged: saving
                      ? null
                      : (value) =>
                            setState(() => candidateResolution = value.single),
                ),
                const SizedBox(height: 20),
                ...
                SegmentedButton<FrameRatePreset>(
                  ...
                  onSelectionChanged: saving
                      ? null
                      : (value) =>
                            setState(() => candidateFrameRate = value.single),
                ),
